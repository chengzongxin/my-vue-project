<template>
  <view class="page">
    ...
    <!-- 装修保障 -->
    <view class="guarantee" id="g_body" @click="onGuaranteeClick">
...
export default class Index extends Vue {
  ...
  onGuaranteeClick(e: any) {
    const { id, offsetTop, y } = e.target
    const { pageY, clientY } = e.changedTouches[0]
    const offsetY = pageY - clientY
    const curY = y + offsetY - offsetTop

    if (id === 'g_body' && curY < 40) {
      console.log(curY)
    }
  }
